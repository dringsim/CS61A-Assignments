...
class Frame:
    ...
    def make_child_frame(self, formals: Pair | nil, vals: Pair | nil) -> Frame:
...
class BuiltinProcedure(Procedure):
    ...
    def __init__(self, py_func: Callable[..., Any], need_env: bool=False, name: str='builtin'):
        self.name: str = name
        self.py_func: Callable[..., Any] = py_func
        self.need_env: bool = need_env
...
class LambdaProcedure(Procedure):
    ...
    def __repr__(self):
        return f'LambdaProcedure({repr(self.formals)}, {repr(self.body)}, {repr(self.env)})'
...
class MuProcedure(Procedure):
    ...
    def __repr__(self):
        return f'MuProcedure({repr(self.formals)}, {repr(self.body)})'
